      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2.5">
            <span className="grid h-7 w-7 place-items-center rounded-sm border border-primary/50 bg-primary/10 font-mono text-[11px] font-semibold text-primary">
              M
            </span>
          ...
          <p className="mt-4 font-mono text-[11px] uppercase tracking-wider text-muted-foreground">
            Crafted by Nykoo · MIT License · Not affiliated with the MCreator project.
          </p>
        </div>
        <div>
